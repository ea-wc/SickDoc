      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
            ...
            <CardContent>
              {appointments.isLoading ? (
                ...
                <div className="flex items-center gap-4">
                  <InitialsAvatar displayName={next.patient.displayName} color={next.patient.avatarColor} />
                  <div className="min-w-0 flex-1">
                    <p className="font-medium">{next.patient.displayName}</p>
                ...
                <EmptyState
                  ...
                  description="Set your availability so patients can book."
                  action={
                    <Button asChild size="sm">
                      <Link href="/doctor/schedule">Set schedule</Link>
                    </Button>
                  }
                />
              )}
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              { icon: CalendarCheck, title: "Schedule", href: "/doctor/schedule" },
              { icon: CalendarClock, title: "Appointments", href: "/doctor/appointments" },
              { icon: Users, title: "Patients", href: "/doctor/patients" },
            ].map((action) => (
